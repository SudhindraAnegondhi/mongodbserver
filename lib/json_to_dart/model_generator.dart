...
import 'package:mongoserver/json_to_dart/helpers.dart';
import 'package:mongoserver/json_to_dart/syntax.dart';
...
class ModelGenerator {
  ...
  ModelGenerator(this._rootClassName, privateFields, List<String> dateFields,
      primaryKey, foreignKeys, noUpdate)
  ...
  List<Warning> _generateClassDefinition(
    ...
    if (jsonRawDynamicData is List) {
      ...
      // TODO: check if this remove is necessary
